...
The [R-builder project](https://github.com/metacran/r-builder) allows to check a package against various versions of R (by default, the latest version, the R-devel version, and R-oldrel, which refers to the last release from the previous minor version). 
